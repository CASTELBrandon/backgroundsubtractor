...
public:
    ...
    static cv::Mat grayImagesDifferencing(cv::Mat const& imageA, cv::Mat const& imageB, uchar const& threshold=127);
    static std::array<int, 3> differenceRGB(std::array<int, 3> const& imageA, std::array<int, 3> const& imageB, int const& threshold);
};
